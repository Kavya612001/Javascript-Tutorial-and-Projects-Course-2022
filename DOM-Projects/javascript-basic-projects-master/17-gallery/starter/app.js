...
function Gallery(element) {
  ...
  this.list = [...element.querySelectorAll(".img")]; //NodeList is converted into array using the spread operator
  //target - all these are selected on the document and not on the element, since modal and all are only once present in a document 
  ...
  //let self = this;
  // bind functions
  //this.openModal = this.openModal.bind(this); //binded to Gallery rather than the section elements
